...
void RH_RF24::setModemRegisters(const ModemConfig* config)
{
    ...
    set_properties(0x2007, &config->prop_2007, 1);
    set_properties(0x2008, &config->prop_2008, 1);
    set_properties(0x2009, &config->prop_2009, 1);
    set_properties(0x200a, &config->prop_200a, 1);
