...
// Note, on Maple and Flymaple, the mapping from interrupt number to pin is different. 
// For interrupts on maple pin 2, pass interrupt pin 2)
RH_RF22 driver(SS, 2);
